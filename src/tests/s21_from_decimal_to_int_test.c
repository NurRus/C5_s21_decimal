...
START_TEST(test_from_dec_to_int_23) {
...
START_TEST(test_from_dec_to_int_24) {
  s21_decimal src;
  src.bits[0] = 0b11111110100100001101100101011111;
  src.bits[1] = 0b10000100011001000010000111101000;
  src.bits[2] = 0b00000000000000000000000000000001;
...
START_TEST(test_from_dec_to_int_25) {
  s21_decimal src;
...
START_TEST(test_from_dec_to_int_26) {
  s21_decimal src;
  src.bits[0] = 0b11111111111111111111111111111111;
  src.bits[1] = 0b10000100011001000010000111101000;
  src.bits[2] = 0b00000000000000000000000000000001;
...
Suite *s21_from_decimal_to_int_suite(void) {
  Suite *s = suite_create("\033[42m-=s21_decimal_to_int_suite=-\033[0m");
  TCase *tc = tcase_create("s21_decimal_to_int_testcase");
  ...
  tcase_add_test(tc, test_from_dec_to_int_23);
  tcase_add_test(tc, test_from_dec_to_int_24);
  tcase_add_test(tc, test_from_dec_to_int_25);
  tcase_add_test(tc, test_from_dec_to_int_26);
