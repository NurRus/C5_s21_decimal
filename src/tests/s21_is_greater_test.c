...
Suite *s21_is_greater_suite(void) {
  ...
  TCase *t = tcase_create("s21_is_greater_testcase");
  tcase_add_test(t, s21_is_greater_1);
  tcase_add_test(t, s21_is_greater_2);
  tcase_add_test(t, s21_is_greater_3);
  tcase_add_test(t, s21_is_greater_4);
  tcase_add_test(t, s21_is_greater_5);
